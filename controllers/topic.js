...
exports.index = function (req, res, next) {
  ...
  if (topic_id.length !== 24) {
    return res.render404('This topic is not exist or has been deleted');
  }
...
exports.put = function (req, res, next) {
  ...
  if (title === '') {
    ...
    editError = 'Title is too short or too long。';
  } else if (!tab || allTabs.indexOf(tab) === -1) {
    editError = 'Please select a topic';
  } else if (content === '') {
...
exports.showEdit = function (req, res, next) {
  ...
  Topic.getTopicById(topic_id, function (err, topic, tags) {
    if (!topic) {
      res.render404('This topic is not exist or has been deleted');
      return;
    }
    ...
    if (String(topic.author_id) === String(req.session.user._id) || req.session.user.is_admin) {
      ...
      res.renderError('Sorry, you have no permission to edit.', 403);
    }
  });
};
...
exports.delete = function (req, res, next) {
  ...
  Topic.getFullTopic(topic_id, function (err, err_msg, topic, author, replies) {
    ...
    if (!topic) {
      res.status(422);
      return res.send({ success: false, message: 'This topic is not exists or has been deleted' });
    }
    author.score -= 5;
    ...
    topic.save(function (err) {
      ...
      res.send({ success: true, message: 'Topic deleted' });
    });
  });
};
...
exports.top = function (req, res, next) {
  ...
  if (topic_id.length !== 24) {
    res.render404('This topic is not exists or has been deleted');
    return;
  }
  Topic.getTopic(topic_id, function (err, topic) {
    ...
    topic.save(function (err) {
      ...
      var msg = topic.top ? 'This topic is pinned' : 'This topic is unpinned。';
...
exports.good = function (req, res, next) {
  ...
  Topic.getTopic(topicId, function (err, topic) {
    ...
    topic.save(function (err) {
      ...
      var msg = topic.good ? 'This topic is selected。' : 'This topic is unselected。';
      res.render('notify/notify', {success: msg, referer: referer});
    });
  });
};
...
exports.lock = function (req, res, next) {
  ...
  Topic.getTopic(topicId, function (err, topic) {
    ...
    topic.save(function (err) {
      ...
      var msg = topic.lock ? 'This topic is locked' : 'This topic is unloced。';
      res.render('notify/notify', {success: msg, referer: referer});
    });
  });
};
